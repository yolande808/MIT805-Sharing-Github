...
class MRTripDurationAvgByHour(MRJob):
    ...
    def mapper(self, _, line):
        ...
        yield pick_up_hour, float(trip_duration)

    def reducer(self, pick_up_hour, trip_duration):
        total = 0
        numElements = 0
        ...
        yield pick_up_hour, total / numElements


if __name__ == '__main__':
    MRTripDurationAvgByHour.run()
